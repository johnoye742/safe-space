    ...
    <main class="h-full w-full flex flex-col">
        <div class="p-5 w-full border-b border-b-gray-200 flex flex-row justify-between items-center">
            <div class="flex flex-col">
                ...
                <p class="text-green-500">1 online</p>
            </div>
        ...
        <div class="max-h-[80vh] h-[80vh] w-full overflow-y-scroll p-6 flex flex-col bg-primary bg-no-repeat bg-cover bg-center" id="main">
